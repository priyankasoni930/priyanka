  ...
  return (
    ...
    >
      <h1 className=" capitalize font-bold text-4xl relative lg:text-6xl tracking-wide">
        Contact Me{" "}
        <span className="  text-8xl lg:text-[9rem] animate-pulse absolute lg:-bottom-2 bottom-0">
          .
        </span>
      </h1>
      ...
      <a
        href="mailto:itsshivahere@outlook.com?body=Hello"
        target="_blank"
      ...
      <form
        className="flex flex-col w-full lg:w-[80%] gap-4"
        autoComplete="off"
        ref={form}
        onSubmit={sendEmail}
      >
        ...
        {loading ? (
          <button
            className="flex justify-center items-center boxshadowbtn gap-3 "
            disabled
          >
